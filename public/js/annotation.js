...
function Annotation(sceneMeta, world, frameInfo) {
  ...
  ;(this.find_boxes_inside_rect = function (x, y, w, h, camera) {
    ...
    (this.proc_annotation = function (boxes) {
      ...
      console.log(this.boxes_load_time, this.frameInfo.scene, this.frameInfo.frame, 'loaded boxes ', this.boxes_load_time - this.world.create_time, 'ms')
  ...
  this.createOneBoxByAnn = function (annotation) {
    ...
    let mesh = this.createCuboid(b.psr.position, b.psr.scale, b.psr.rotation, b.obj_type, b.obj_id, b.obj_attr)
